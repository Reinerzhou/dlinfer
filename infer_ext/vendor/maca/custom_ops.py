...
def add_rms_norm(
    ...
    if normed_output is None and added_output is None:
        normed_output = hidden_states
        added_output = residual
    else:
        normed_output.copy_(hidden_states)
        added_output.copy_(added_output)
    return normed_output, added_output
...
def context_attention(
    ...
    maca_ext_ops.flash_attn_varlen_fwd(
        query,
        key,
        value,
        attn_output,
